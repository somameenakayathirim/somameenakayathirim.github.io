  ...
  const skillCategories = [
    {
      title: 'Languages',
      icon: Code,
      skills: ['Java', 'Python', 'Groovy'],
      color: 'from-blue-500 to-blue-700',
    },
    {
      title: 'Frameworks & Microservices',
      icon: GitBranch,
      skills: ['Spring Boot', 'API & Microservices', 'Flowable Engage'],
      color: 'from-indigo-500 to-indigo-700',
    },
    {
      title: 'Cloud & Infrastructure',
      icon: Cloud,
      skills: ['Amazon Web Services', 'Terraform', 'Docker', 'Kubernetes – EKS, AKS'],
      color: 'from-cyan-500 to-cyan-700',
    },
    {
      title: 'DevOps & Security',
      icon: Cpu,
      skills: ['DevSecOps', 'GitLab', 'Trivy', 'SonarQube'],
